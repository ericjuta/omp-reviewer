...
- Normalize only safe submission metadata before validation: shorten overlong titles and infer a missing priority only from an exact `[P0]` through `[P3]` title prefix.
